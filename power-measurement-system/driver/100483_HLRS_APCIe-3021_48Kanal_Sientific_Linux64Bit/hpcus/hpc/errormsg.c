...
static const char WRONG_HARDWARE_TRIGGER_PARAMETER[] = "Wrong hardware trigger parameter";
static const char WRONG_HARDWARE_TRIGGER_LEVEL_PARAMETER[] = "Wrong hardware trigger level parameter";
static const char WRONG_HARDWARE_TRIGGER_ACTION_PARAMETER[] = "Wrong hardware trigger action parameter";
static const char WRONG_HARDWARE_TRIGGER_COUNT_PARAMETER[] = "Wrong hardware trigger count parameter";
static const char NO_ANALOG_INPUT_FUNCTIONALITY[] = "No analog input functionality available";
...
const char* msg_CMD_xpci3xxx_EnableDisableAnalogInputHardwareTrigger(int nb)
{
	switch(nb)
	{
		...
		case 1:
			return WRONG_BOARD_HANDLE;
		case 2:
			return WRONG_HARDWARE_TRIGGER_PARAMETER;
		case 3:
			return WRONG_HARDWARE_TRIGGER_LEVEL_PARAMETER;
		case 4:
			return WRONG_HARDWARE_TRIGGER_ACTION_PARAMETER;
		case 5:
			return WRONG_HARDWARE_TRIGGER_COUNT_PARAMETER;
		case 6:
			return NO_ANALOG_INPUT_FUNCTIONALITY;
		case 7:
